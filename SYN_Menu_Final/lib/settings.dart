...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  void _loadAllergiesFromPrefs() async {
    ...
    if (allergiesJson != null) {
      ...
      List<String> allergies = allergiesList.map<String>((allergy) => allergy as String).toList();
      setState(() {
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            MyWidget(onSelectionChanged: (selected) {
              setState(() {
                selectedAllergies = selected;
              });
            }, selectedAllergies: selectedAllergies, items: const [],),
